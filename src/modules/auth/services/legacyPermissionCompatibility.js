...
export const LEGACY_PERMISSION_MAP = {
  ...
  "servico.view": ["servicos"],
  "servico.create": ["servicos"],
  "servico.edit": ["servicos"],
  "servico.delete": ["servicos"],
  "plantao.view": ["plantoes"],
  "plantao.create": ["plantoes"],
  "plantao.edit": ["plantoes"],
  "plantao.delete": ["plantoes"],
  "inventory.view": ["estoque_np"],
  "inventory.create": ["estoque_np"],
  "inventory.edit": ["estoque_np"],
  "inventory.delete": ["estoque_np"],
  "estoque_nao_publicitado.view": ["estoque_np"],
  "estoque_nao_publicitado.view_private_data": ["estoque_np"],
  "estoque_nao_publicitado.create": ["estoque_np"],
  "estoque_nao_publicitado.edit": ["estoque_np"],
  "estoque_nao_publicitado.delete": ["estoque_np"],
  "estoque_nao_publicitado.create_client": ["estoque_np"],
  "estoque_nao_publicitado.create_development": ["estoque_np"],
  "estoque_nao_publicitado.create_unit": ["estoque_np"],
  "estoque_nao_publicitado.edit_client": ["estoque_np"],
  "estoque_nao_publicitado.edit_development": ["estoque_np"],
  "estoque_nao_publicitado.edit_unit": ["estoque_np"],
  "estoque_nao_publicitado.delete_client": ["estoque_np"],
  "estoque_nao_publicitado.delete_development": ["estoque_np"],
  "estoque_nao_publicitado.delete_unit": ["estoque_np"],
  "users.view": ["usuarios"],
