...
export function criarUsuariosViewModel({
  ...
  return {
    ...
    conta: {
      ...
      ocultarReenviarConvite: resolveAccountStatus(usuarioSelecionadoMeta, form) === "active",
      mensagemConvite: resolveAccountStatus(usuarioSelecionadoMeta, form) === "active" ? "Conta já ativa" : "",
      mostrarAcaoRedefinicao: resolveAccountStatus(usuarioSelecionadoMeta, form) === "active",
